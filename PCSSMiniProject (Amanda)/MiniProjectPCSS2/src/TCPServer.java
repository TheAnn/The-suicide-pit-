...
public class TCPServer2 {
	...
	public static void setClientMessage(String clientMessage) {
		TCPServer2.clientMessage = clientMessage;
	}
	...
	public static void main (String[] args){
		...
		do { 
			...
			try {
				...
				ClientHandlerInput handlerInput = new ClientHandlerInput(clientInput);
				handlerInput.start();
				...
				ClientHandlerOutput handlerOutput = new ClientHandlerOutput(clientOutput);
				handlerOutput.start();
